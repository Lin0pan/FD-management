 ...
 * the six writes that told the staff member nothing at all. It carries no payload: what changed is
 * the status, and `BlockControls` knows which of the two writes produced the one it is now rendering.
 */

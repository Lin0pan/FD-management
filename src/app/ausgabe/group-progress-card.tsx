...
/** `outline` rather than a colour: having collected is a plain fact, not a warning. */
const SERVED_CHROME = { variant: "outline" } as const;

/**
 * One household of the group: number and name as one link, their state after it. Both sit *inside*
 * the link, so the accessible name is „312 Ada Lovelace“ — what a staff member would say out loud —
 * rather than a bare name a screen reader cannot place in the column of numbers.
 */

...
/**
 * Proves the architecture boundary is *enforced*, not merely documented (ADR-001): that `npm run lint`
 * actually fails on a violation, so the boundary survives an unattended agent run.
 *

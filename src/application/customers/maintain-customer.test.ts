...
class FakeCustomerRepository implements CustomerRepository {
  ...
  /**
   * The two group sizes, counted off the numbers the holders hold — the parity *is* the group
   * (US-31) — with archived households excluded, because they turn up to nothing.
   */

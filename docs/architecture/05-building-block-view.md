...
| `distribution/`         | What happens on a distribution day: the counter verdict and its fixed precedence, one hand-out per Berlin calendar day, the customer balance and the amount to collect, week-colour alternation from a single anchor, the served/expected tally, consecutive no-shows                                                                                                                              |

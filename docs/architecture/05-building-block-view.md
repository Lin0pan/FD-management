...
### `src/application/` — 43 use cases behind twelve ports
...
| `distribution/` | Start, discard, end and reopen the distribution session and read its state — ending freezes the households it served and reopening thaws them — record and correct a hand-out, read the group roster                                                                                                                                                                                                                                                                  |

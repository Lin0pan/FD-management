...
| `policy/`               | Settings as immutable versions, resolution at an instant, portions per head, price with cap, and the diff two versions produce                                                                                                                         |
...
| `allowance/`    | The single seam that turns a household plus a date into portions and a price                                                                                                                                                                                                                                   |

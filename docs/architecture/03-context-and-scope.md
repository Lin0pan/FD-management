...
| DF's manager                         | Set the policy values and the Nachweis-Art list                   | Inbound                             | Quota, prices per head, price cap, egg rule, Nachweis-Arten                          | The `/einstellungen` screen        | DF                                                                                |

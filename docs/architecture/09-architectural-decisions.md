...
| 2026-07-30 | No form library, no toast library, no date picker, no chart library                                    | `react-hook-form` fights `useActionState`, and native date inputs are better for keyboard-heavy entry                  |

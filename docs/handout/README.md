...
| Document                                         | Purpose                                                                                                                                                    |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`betriebsanleitung.md`](./betriebsanleitung.md) | Starting, stopping, where the data lives, backup, restore, the egg allowance, the balance and how a payment is put right, what to do when something breaks |

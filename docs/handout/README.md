...
| Document                                         | Purpose                                                                                                                                                                                                                                                                                          |
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`betriebsanleitung.md`](./betriebsanleitung.md) | Starting, stopping, where the data lives, backup, restore, the egg allowance, starting and ending a distribution, looking an earlier one up, what the missed-distribution count counts, the balance and how a payment is put right, changing a customer number, what to do when something breaks |
